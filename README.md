...
**Update (March 19):** The NYC Health Dep. just started sharing more detailed data, but now counting all cases treated in NYC (not only residents as before and as used in the visualization below). That data is now being shared in this [PDF file](https://www1.nyc.gov/assets/doh/downloads/pdf/imm/covid-19-daily-data-summary.pdf). I'll collect and visualize this data soon.
