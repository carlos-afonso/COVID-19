...
Note that today's (March 23) data is incomplete because it's only as of 9:25 am. This is particularly relevant when looking at the trends in two plots below (total cases and new cases over time), because the last data point (in both plots) is very likely to go up once we get the data for the full day.
